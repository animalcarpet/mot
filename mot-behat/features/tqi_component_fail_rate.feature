...
Feature: TQI Component Fail Rate
  ...
  Scenario: Get the tester performance statistics at site for the last month
    When I am logged in as a Tester "Kowalsky"
    Then I should be able to see component fail rate statistics performed "1" months ago at site "Fast cars garage" for tester "Kowalsky" and group "A"
  ...
  @test-quality-information
  Scenario: Get the tester performance statistics at site for the last month after changing AE
