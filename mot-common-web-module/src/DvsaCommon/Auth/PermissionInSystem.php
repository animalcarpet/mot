...
final class PermissionInSystem
{
    ...
    const CERTIFICATE_REPLACEMENT_DVLA_CHANGE =
        'CERTIFICATE-REPLACEMENT-DVLA-CHANGE';
    const VEHICLE_UPDATE = 'VEHICLE-UPDATE';
    const VEHICLE_SPECIAL_FIELD_UPDATE = 'VEHICLE-SPECIAL-FIELD-UPDATE';
    ...
    const MANAGE_ROLE_CUSTOMER_SERVICE_CENTRE_OPERATIVE =  'MANAGE-ROLE-CUSTOMER-SERVICE-CENTRE-OPERATIVE';
    const MANAGE_ROLE_CUSTOMER_SERVICE_MANAGER = 'MANAGE-ROLE-CUSTOMER-SERVICE-MANAGER';
    ...
    const MANAGE_ROLE_DVSA_SCHEME_MANAGEMENT = 'MANAGE-ROLE-DVSA-SCHEME-MANAGEMENT';
    const MANAGE_ROLE_DVSA_SCHEME_USER = 'MANAGE-ROLE-DVSA-SCHEME-USER';
    const MANAGE_ROLE_DVSA_CENTRAL_ADMIN_TEAM = 'MANAGE-ROLE-DVSA-CENTRAL-ADMIN-TEAM';
    ...
    const MANAGE_MYSTERY_SHOPPER_CAMPAIGN = 'MANAGE-MYSTERY-SHOPPER-CAMPAIGN';
    ...
    const AUTHENTICATE_WITH_2FA = 'AUTHENTICATE-WITH-2FA';
    const GENERATE_SATISFACTION_SURVEY_REPORT = 'GENERATE-SATISFACTION-SURVEY-REPORT';
    const VIEW_QUA_DETAILS_OF_ANOTHER_USER = 'VIEW-QUA-DETAILS-OF-ANOTHER-USER';
    const CREATE_MOT_TESTING_CERTIFICATE_FOR_USER = 'CREATE-MOT-TESTING-CERTIFICATE-FOR-USER';
    const UPDATE_MOT_TESTING_CERTIFICATE_FOR_USER = 'UPDATE-MOT-TESTING-CERTIFICATE-FOR-USER';
    const VIEW_USERS_IN_DEMO_TEST_NEEDED_STATE = 'VIEW-USERS-IN-DEMO-TEST-NEEDED-STATE';
    const REMOVE_MOT_TESTING_CERTIFICATE_FOR_USER = 'REMOVE-MOT-TESTING-CERTIFICATE-FOR-USER';
    const CREATE_MOT_TESTING_ANNUAL_CERTIFICATE_FOR_USER = 'CREATE-MOT-TESTING-ANNUAL-CERTIFICATE-FOR-USER';
    const UPDATE_MOT_TESTING_ANNUAL_CERTIFICATE_FOR_USER = 'UPDATE-MOT-TESTING-ANNUAL-CERTIFICATE-FOR-USER';
    const VIEW_MOT_TESTING_ANNUAL_CERTIFICATE_FOR_USER = 'VIEW-MOT-TESTING-ANNUAL-CERTIFICATE-FOR-USER';
    const REMOVE_MOT_TESTING_ANNUAL_CERTIFICATE_FOR_USER = 'REMOVE-MOT-TESTING-ANNUAL-CERTIFICATE-FOR-USER';
    const TESTER_VIEW_TEST_LOGS = 'TESTER-VIEW-TEST-LOGS';
    const TESTER_VIEW_TEST_QUALITY = 'TESTER-VIEW-TEST-QUALITY';
    const CAN_VIEW_OTHER_2FA_SECURITY_CARD = 'CAN-VIEW-OTHER-2FA-SECURITY-CARD';
    const CAN_ORDER_2FA_SECURITY_CARD = 'CAN-ORDER-2FA-SECURITY-CARD';
    const CAN_ORDER_2FA_SECURITY_CARD_FOR_OTHER_USER = 'CAN-ORDER-2FA-SECURITY-CARD-FOR-OTHER-USER';
    const VIEW_SECURITY_CARD_ORDER = 'VIEW-SECURITY-CARD-ORDER';
    const MANAGE_ROLE_CENTRAL_ADMIN_TEAM = 'MANAGE-ROLE-CENTRAL-ADMIN-TEAM';
    const VEHICLE_CHANGE_PROPERTY_EXPANDED = 'VEHICLE-CHANGE-PROPERTY-EXPANDED';
    ...
    public static function all()
    {
        return [
            ...
            self::CERTIFICATE_REPLACEMENT_DVLA_CHANGE,
            self::VEHICLE_UPDATE,
            self::VEHICLE_SPECIAL_FIELD_UPDATE,
            ...
            self::MANAGE_ROLE_CUSTOMER_SERVICE_CENTRE_OPERATIVE,
            self::MANAGE_ROLE_CUSTOMER_SERVICE_MANAGER,
            ...
            self::MANAGE_ROLE_DVSA_SCHEME_MANAGEMENT,
            self::MANAGE_ROLE_DVSA_SCHEME_USER,
            self::MANAGE_ROLE_DVSA_CENTRAL_ADMIN_TEAM,
            self::MANAGE_ROLE_FINANCE,
            self::MANAGE_ROLE_VEHICLE_EXAMINER,
            self::MANAGE_DVSA_ROLES,
            self::MANAGE_MYSTERY_SHOPPER_CAMPAIGN,
            ...
            self::AUTHENTICATE_WITH_2FA,
            self::GENERATE_SATISFACTION_SURVEY_REPORT,
            self::CREATE_MOT_TESTING_CERTIFICATE_FOR_USER,
            self::UPDATE_MOT_TESTING_CERTIFICATE_FOR_USER,
            self::VIEW_USERS_IN_DEMO_TEST_NEEDED_STATE,
            self::REMOVE_MOT_TESTING_CERTIFICATE_FOR_USER,
            self::VIEW_MOT_TESTING_ANNUAL_CERTIFICATE_FOR_USER,
            self::CREATE_MOT_TESTING_ANNUAL_CERTIFICATE_FOR_USER,
            self::UPDATE_MOT_TESTING_ANNUAL_CERTIFICATE_FOR_USER,
            self::REMOVE_MOT_TESTING_ANNUAL_CERTIFICATE_FOR_USER,
            self::TESTER_VIEW_TEST_LOGS,
            self::TESTER_VIEW_TEST_QUALITY,
            self::CAN_VIEW_OTHER_2FA_SECURITY_CARD,
            self::CAN_ORDER_2FA_SECURITY_CARD,
            self::CAN_ORDER_2FA_SECURITY_CARD_FOR_OTHER_USER,
            self::VIEW_SECURITY_CARD_ORDER,
            self::MANAGE_ROLE_CENTRAL_ADMIN_TEAM,
            self::TESTER_VIEW_TEST_QUALITY,
            self::VEHICLE_CHANGE_PROPERTY_EXPANDED,
