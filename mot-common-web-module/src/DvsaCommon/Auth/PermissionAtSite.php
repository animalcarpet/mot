...
class PermissionAtSite
{
    ...
    const VIEW_MOT_TESTING_ANNUAL_CERTIFICATE_FOR_SITE_USER = 'VIEW-MOT-TESTING-ANNUAL-CERTIFICATE-FOR-SITE-USER';
    const TESTERS_ANNUAL_ASSESSMENT_VIEW = 'TESTERS-ANNUAL-ASSESSMENT-VIEW';
    const VTS_VIEW_AVERAGE_TEST_QUALITY = 'VTS-VIEW-AVERAGE-TEST-QUALITY';
    ...
    public static function all()
    {
        return [
            ...
            self::TESTERS_ANNUAL_ASSESSMENT_VIEW,
            self::VIEW_MOT_TESTING_ANNUAL_CERTIFICATE_FOR_SITE_USER,
            self::VTS_VIEW_AVERAGE_TEST_QUALITY,
        ];
    }
}
