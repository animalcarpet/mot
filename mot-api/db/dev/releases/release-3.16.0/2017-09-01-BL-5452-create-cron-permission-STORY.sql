...
VALUES ('Send monthly TQI notification to SMs', 'NOTIFY-SM-ABOUT-TQI-STATS', 0, @app_user_id,  CURRENT_TIMESTAMP (6), @app_user_id, CURRENT_TIMESTAMP (6));

SET @permission_id = (SELECT `id` FROM `permission` WHERE `code` = "NOTIFY-SM-ABOUT-TQI-STATS");
