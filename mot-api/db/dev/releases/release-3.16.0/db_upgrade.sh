...
upgrade_files+=('2017-08-31-BL-5451-create-cron-permission-STORY.sql');
upgrade_files+=('2017-08-31-BL-5451-create-notification-template-STORY.sql');
upgrade_files+=('2017-09-01-BL-5452-create-cron-permission-STORY.sql');
upgrade_files+=('2017-09-01-BL-5452-create-notification-template-STORY.sql');
