...
class Notification
{
    ...
    const TEMPLATE_SITE_ASSESSMENT_CREATED = 34;
    const TEMPLATE_AED_AND_AEDM_MONTHLY_NOTIFICATION_ABOUT_TQI = 35;
    const TEMPLATE_SM_MONTHLY_NOTIFICATION_ABOUT_TQI = 36;
